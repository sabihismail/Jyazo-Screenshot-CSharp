...
namespace Capture.Hook
{
    ...
    /// </summary>
    internal class DXHookD3D101: BaseDXHook
    {
        private const int D_3D10_1_DEVICE_METHOD_COUNT = 101;

        public DXHookD3D101(CaptureInterface ssInterface)
            : base(ssInterface)
        {
            DebugMessage("Create");
        }

        private List<IntPtr> d3d101VTblAddresses;
